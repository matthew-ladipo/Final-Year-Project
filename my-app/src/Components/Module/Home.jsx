...
import imgs from "../../Images/image-hero-desktop.png";
...
const Home = ({ logout }) => {
  ...
  const navItems = [
    { nav: "Home", logo: <LuLayoutDashboard />, url: "over" },
    { nav: "Departments", logo: <MdGroups /> },
    { nav: "Computer Science", logo: <RiComputerLine />, url: "computer" },
    { nav: "Mathenatics", logo: <TbMathSymbols />, url: "maths" },
    { nav: "Bio Chemistry", logo: <MdOutlineBiotech />, url: "bio" },
    { nav: "Chemistry", logo: <SlChemistry />, url: "chem" },
    { nav: "Lecture Materials", logo: <BiSolidCategory />, url: "add" },
    { nav: "About", logo: <FaChalkboardTeacher />, url: "about" },
  ];
  ...
  return (
    <>
      <div className="h-full">
        ...
        <div className=" flex  border-r-[3px] border-solid border-gray-300  ">
          <aside className="px-10 py-[30px]  bg-purple-300 ">
            <>
              <div className="">
                {navItems.map((items, index) => (
                  ...
                  >
                    <Link
                      to={items.url}
                      className="flex items-center my-5 gap-2 text-gray-500 cursor-pointer hover:text-purple-500 "
                    >
            ...
            <img src={imgs} alt="image" className="w-20   ml-1" />
          </aside>
          <Outlet />
        </div>
      </div>
