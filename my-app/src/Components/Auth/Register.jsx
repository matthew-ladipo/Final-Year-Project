...
const Register = () => {
  ...
  return (
    <div className="flex justify-center items-center ">
      <div className=" mx-10 px-10  mt-10 bg-white shadow-2xl rounded">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center text-sm text-gray-400">
                <input
                  className="form-checkbox accent-purple-500 h-4 w-4 text-purple-600 bg-gray-800 border-gray-500 rounded"
                  type="checkbox"
                />
